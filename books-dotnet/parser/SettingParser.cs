...
namespace zohobooks.parser
{
    ...
    internal class SettingsParser
    {
        ...
        internal static TaxAuthorityList getTaxAuthorityList(HttpResponseMessage response)
        {
            ...
            {
                var taxAuthorityArray =
                    JsonConvert.DeserializeObject<List<object>>(jsonObj["tax_authorities"].ToString());
        ...
        internal static TaxExemptionList getTaxExemptionList(HttpResponseMessage response)
        {
            ...
            {
                var taxExemptionArray =
                    JsonConvert.DeserializeObject<List<object>>(jsonObj["tax_exemptions"].ToString());
