...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/estimates";
        ...
        ///     <table>
        ///         <tr>
        ///             <td>estimate_number</td>
        ///             <td>
        ///                 Search estimates by estimate number.<br></br>Variants: <i>estimate_number_startswith</i> and
        ///                 <i>estimate_number_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>reference_number</td>
        ///             <td>
        ///                 Search estimates by reference number.<br></br>Variants: <i>reference_number_startswith</i> and
        ...
        ///             <td>customer_name</td>
        ///             <td>
        ///                 Search estimates by customer name.<br></br>Variants: <i>customer_name_startswith</i> and
        ...
        ///             <td>total</td>
        ///             <td>
        ///                 Search estimates by estimate total.<br></br>Variants:
        ///                 <i>total_less_than, total_less_equals, total_greater_than</i> and <i>total_greater_equals</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>customer_id</td><td>Search estimates by customer id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_id</td><td>Search estimates by item id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_name</td>
        ///             <td>
        ///                 Search estimates by item name.<br></br>Variants: <i>item_name_startswith</i> and
        ...
        ///             <td>
        ///                 Search estimates by item description.><br></br>Variants: <i>item_description_startswith</i> and
        ...
        ///             <td>custom_field</td>
        ///             <td>
        ///                 Search estimates by custom field.<br></br>Variants: <i>custom_field_startswith</i> and
        ...
        ///             <td>expiry_date</td>
        ///             <td>
        ///                 Search estimates by expiry date.<br></br>Variants:
        ///                 <i>expiry_date_start, expiry_date_end, expiry_date_before</i> and <i>expiry_date_after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>date</td>
        ///             <td>
        ///                 Search estimates by estimate date.<br></br>Variants: <i>date_start, date_end, date_before</i> and
        ///                 <i>date_after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>status</td>
        ///             <td>
        ///                 Search estimates by status.<br></br>Allowed Values: <i>draft, sent, invoiced, accepted, declined</i>
        ///                 and <i>expired</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ///                 Filter estimates by status.<br></br>Allowed Values:
        ///                 <i>Status.All, Status.Sent, Status.Draft, Status.Invoiced, Status.Accepted, Status.Declined</i> and
        ///                 <i>Status.Expired</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>search_text</td><td>Search estimates by estimate number or reference or customer name.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_column</td>
        ///             <td>
        ///                 Sort estimates.<br></br>Allowed Values: <i>customer_name, estimate_number, date, total</i> and
        ///                 <i>created_time</i>
        ///             </td>
        ///         </tr>
        ///     </table>
        ...
        /// <param name="parameters">
        ///     The parameters is the dictionary object which contains the parameters in the key,value pairs.<br></br>The possible
        ///     parameters are listed below<br></br>
        ///     <table>
        ///         <tr>
        ...
        ///             <td>accept</td>
        ///             <td>
        ///                 Get the details of a particular estimate in formats such as json/ pdf/ html. Default format is json.
        ...
        /// </summary>
        /// <param name="new_estimate_info">
        ///     The new_estimate_info is the Estimate object with contact_id and item_name are
        ///     mandatory attributes.
        /// </param>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which contains the parameters in the key,value pairs.<br></br>The
        ///     parameters are listed below<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>send</td>
        ///             <td>
        ///                 Send the estimate to the contact person(s) associated with the estimate.<br></br>Allowed Values:
        ...
        ///             <td>
        ///                 Ignore auto estimate number generation for this estimate. This mandates the estimate number.<br></br>
        ...
        /// <param name="parameters">
        ///     The parameters is the Dictionary object.<br></br>The possible parameters are <br></br>
        ///     <table>
        ///         <tr>
        ///             <td>ignore_auto_number_generation</td>
        ///             <td>
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/status/sent";
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/status/accepted";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            var responceContent = responce.Content.ReadAsStringAsync().Result;
            return EstimateParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/status/declined";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            var responceContent = responce.Content.ReadAsStringAsync().Result;
            return EstimateParser.getMessage(responce);
        }
        ...
        /// <summary>
        ///     Email an estimate to the customer. Input json string is not mandatory. If input json string is empty, mail will be
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/email";
        ...
        /// </summary>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which contains the key,value pair parameters.<br></br>The parameters are
        ///     <br></br>
        ///     <table>
        ///         <tr>estimate_ids*<td></td><td>Comma separated estimate ids which are to be emailed.</td></tr>
        ///     </table>
        /// </param>
        ...
        /// <summary>
        ///     Updates the billing address for this estimate alone. You can set this address as default billing address for your
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/address/billing";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
        ...
        /// <summary>
        ///     Update the shipping address for an existing estimate alone (You can set this address as default shipping address
        ///     for your customer by specifying 'is_update_customer' param as true).
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <param name="update_info">The update_info is the Address object which contains the change details.</param>
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/address/shipping";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.put(url, getQueryParameters(jsonstring));
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/templates/" + template_id;
...
//--------------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/comments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
        ...
        {
            var url = baseAddress + "/" + estimate_id + "/comments/" + comment_id;
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.put(url, getQueryParameters(jsonstring));
