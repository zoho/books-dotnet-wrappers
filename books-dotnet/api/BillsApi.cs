...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/bills";
        ...
        ///     The parameters contains the fiters to refine the bills list in the form of key value pairs.<br></br>The possible
        ///     filter keys and the corespondent allowed values is listed below\
        ///     <table>
        ///         <tr>
        ///             <td>reference_number</td>
        ///             <td>
        ///                 Search bills by reference number.<br></br>Variants: <i>reference_number_startswith</i> and
        ...
        ///             <td>bill_number</td>
        ///             <td>
        ///                 Search bills by bill number.<br></br>Variants: <i>bill_number_startswith</i> and
        ///                 <i>bill_number_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>date</td>
        ///             <td>
        ///                 Search bills by bill date.<br></br>Variants: <i>date_start, date_end, date_before</i> and
        ///                 <i>date.after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>status</td>
        ///             <td>
        ///                 Search bills by bill status.<br></br>Allowed Values: <i>paid, open, overdue, void</i> and
        ///                 <i>partially_paid</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>description</td>
        ///             <td>
        ///                 Search bills by description.<br></br>Variants: <i>description_startswith</i> and
        ...
        ///             <td>vendor_name</td>
        ///             <td>
        ///                 Search bills by vendor name.<br></br>Variants: <i>vendor_name_startswith</i> and
        ...
        ///             <td>total</td>
        ///             <td>
        ///                 Search bills by bill total.<br></br>Variants:
        ///                 <i>total_less_than, total_less_equals, total_greater_than</i> and <i>total_greater_equals</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>vendor_id</td><td>Search bills by bill vendor id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_id</td><td>Search bills by bill item id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ///                 Filter bills by any status.<br></br>Allowed Values:
        ///                 <i>Status.All, Status.PartiallyPaid, Status.Paid, Status.Overdue, Status.Void </i>and
        ///                 <i>Status.Open</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>search_text</td><td>Search bills by bill number or reference number or vendor name.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_coloumn</td>
        ///             <td>
        ///                 Sort bills.<br></br>Allowed Values: <i>vendor_name, bill_number, date, due_date, total, balance</i> and
        ///                 <i>created_time</i>
        ///             </td>
        ///         </tr>
        ///     </table>
        ...
        /// </summary>
        /// <param name="new_bill_info">
        ///     The new_bill_info is the bill object which contains the vendor_id,account_id and
        ///     bill_number as mandatory parameters.
        /// </param>
        ...
        public Bill Create(Bill new_bill_info, string attachment_path)
        {
            ...
            var attachments = new[] {attachment_path};
        ...
        ///     The update_info is the bill object which contains the vendor_id,account_id and bill_number as
        ...
        {
            var url = baseAddress + "/" + bill_id + "/status/open";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return BillParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + bill_id + "/address/billing";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
        ...
        {
            var url = baseAddress + "/" + bill_id + "/payments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
        ...
        {
            var url = baseAddress + "/" + bill_id + "/payments" + "/" + bill_payment_id;
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return BillParser.getMessage(responce);
        }
        //---------------------------------------------------------------------------------------------------
        ...
        /// <param name="bill_id">The bill_id is the identifier of the bill.</param>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which is optionally having the boolean value of
        ///     preview as key,value pair.
        /// </param>
        ...
        {
            var url = baseAddress + "/" + bill_id + "/attachment";
        ...
        {
            var url = baseAddress + "/" + bill_id + "/comments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
        ...
        {
            var url = baseAddress + "/" + bill_id + "/comments/" + comment_id;
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return BillParser.getMessage(responce);
        }
    }
