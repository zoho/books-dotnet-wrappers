...
namespace zohobooks.api
{
    ...
    ///     Get the details of the specified creditnote,refund of a creditnote,email content and email history of a creditnote.
    ///     <br></br>
    ///     Send a mail to a cutomer.<br></br>
    ///     Add a creditnote refund or comment for the credit note.<br></br>
    ///     Update the details,creditnote refund,pdf templates,billing and shipping addresses of the specifed creditnote.
    ///     <br></br>
    ///     Change the status as to open or void.<br></br>
    ///     Delete the existing creditnote,credits applied to the invoices, creitnote refund and comments of the specified
    ///     credit note. <br></br>
    /// </summary>
    public class CreditNotesApi : Api
    {
        private static readonly string baseAddress = baseurl + "/creditnotes";
        ...
        ///     pairs.<br></br>The possible filters are described in the following list<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>creditnote_number</td>
        ///             <td>
        ///                 Search credit notes by credit note number.<br></br>Variants: <i>creditnote_number_startswith</i> and
        ///                 <i>creditnote_number_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>date</td>
        ///             <td>
        ///                 Search credit notes by credit note date.<br></br>Variants: <i>date_start, date_end, date_before</i> and
        ///                 <i>date_after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>status</td>
        ///             <td>
        ///                 Search credit notes by credit note status. Allowed statuses are draft,open,closed and void.<br></br>
        ///                 Allowed Values: <i>open, closed</i> and <i>void</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>total</td>
        ///             <td>
        ///                 Search credit notes by credit note total amount.<br></br>Variants:
        ...
        ///             <td>
        ///                 Search credit notes by credit note reference number.<br></br>Variants: reference_number_startswith and
        ...
        ///             <td>customer_name</td>
        ///             <td>
        ///                 Search credit notes by customer name.<br></br>Variants: <i>customer_name_startswith</i> and
        ...
        ///             <td>item_name</td>
        ///             <td>
        ///                 Search credit notes by item name.<br></br>Variants: <i>item_name_startswith</i> and
        ...
        ///             <td>
        ///                 Search credit notes by credit note item description.<br></br>Variants:
        ///                 <i>item_description_startswith</i> and <i>item_description_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>customer_id</td><td>Search credit notes by customer id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>line_item_id</td><td>Search credit notes by credit note line item id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_id</td><td>Search credit notes by item id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>tax_id</td><td>Search credit notes by tax id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ///                 Filter credit notes by statuses.<br></br>Allowed Values:
        ///                 <i>Status.All, Status.Open, Status.Draft, Status.Closed</i> and <i>Status.Void</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>search_text</td>Search credit notes by credit note number or customer name or credit note reference
        ///             number.<td></td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_column</td>
        ///             <td>
        ///                 Sort credit notes by following columns customer_name, creditnote_number, balance, total, date and
        ///                 created_time.<br></br>Allowed Values: <i>customer_name, creditnote_number, balance, total, date</i> and
        ///                 <i>created_time</i>
        ///             </td>
        ///         </tr>
        ///     </table>
        ...
        /// <param name="parameters">
        ///     The parameters is the dictionary object which is having the optional parameters.<br></br>Those are<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>ignore_auto_number_generation</td>
        ///             <td>
        ...
        {
            var url = baseAddress + "/" + creditnote_id;
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/status/open";
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/status/void";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return CreditNoteParser.getMessage(responce);
        }
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="mail_content_info">
        ///     The mail_content_info is the EmailNotification object with to_mail_ids,subject and body
        ///     as mandatory parameters.
        /// </param>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which is having the option parameter of customer_id as
        ///     a key,value pair.
        /// </param>
        /// <returns>System.String.<br></br>The success message is "Your credit note has been sent."</returns>
        public string SendEmail(string creditnote_id, EmailNotification mail_content_info,
        ...
        /// <summary>
        ///     Updates the billing address for an existing credit note alone. You can set this address as default billing address
        ///     for your customer by specifying 'is_update_customer' node as true.
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/address/billing";
            var json = JsonConvert.SerializeObject(update_info);
        ...
        /// <summary>
        ///     Updates the shipping address for an existing credit note alone. You can set this address as default shipping
        ///     address for your customer by specifying 'is_update_customer' node as true.
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="update_info">The update_info is the Address object which contains the changes information.</param>
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/address/shipping";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.put(url, getQueryParameters(jsonstring));
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/templates/" + template_id;
...
//---------------------------------------------------------------------------------------------
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="invoices_to_apply">
        ///     The invoices_to_apply is the ApplyToInvoices object which is having the information
        ///     regarding for which invoices the specifed creditnote is going to apply with invoice_id and amount_applied are
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/invoices/" + creditnote_invoice_id;
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return CreditNoteParser.getMessage(responce);
        }
...
//-----------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + creditnote_id + "/comments/" + comment_id;
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return CreditNoteParser.getMessage(responce);
        }
    }
