...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/chartofaccounts";
        ...
        ///     The parameters is the dictionary object wich is having the filters in the form of key,value pairs to refine the
        ///     List.<br></br>The possible filters are listed below<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>showbalance</td><td>Boolean to get current balance of accounts.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ///                 Filter accounts based on its account type and status.<br></br>Allowed Values:
        ///                 <i>
        ///                     AccountType.All, AccountType.Active, AccountType.Inactive, AccountType.Asset, AccountType.Liability,
        ///                     AccountType.Equity, AccountType.Income
        ///                 </i>
        ///                 and <i>AccountType.Expense</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_column</td>
        ///             <td>Sort accounts<br></br>Allowed Values: <i>account_name</i> and <i>account_type</i></td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        ///     The update_info is the ChartOfAccount object which contains the information regarding the
        ///     changes with account_type as a mandatory parameter.
        /// </param>
        /// <returns>ChartOfAccount object.</returns>
