...
namespace zohobooks.api
{
    ...
    public class SalesordersApi : Api
    {
        ...
        ///     The base address
        /// </summary>
        private static readonly string baseAddress = baseurl + "/salesorders";
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/status/open";
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/status/void";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return SalesorderParser.getMessage(responce);
        }
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns>System.String.</returns>
        public string SendEmail(string salesorder_id, EmailNotification email_details,
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/address/billing";
            var json = JsonConvert.SerializeObject(update_info);
            var parameters = new Dictionary<object, object>();
            parameters.Add("JSONString", json);
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/address/shipping";
            var json = JsonConvert.SerializeObject(update_info);
            var parameters = new Dictionary<object, object>();
            parameters.Add("JSONString", json);
            var response = ZohoHttpClient.put(url, getQueryParameters(parameters));
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/templates/" + template_id;
...
//---------------------------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/attachment";
            ZohoHttpClient.getFile(url, getQueryParameters(parameters));
...
//----------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + salesorder_id + "/comments";
            var response = ZohoHttpClient.get(url, getQueryParameters());
