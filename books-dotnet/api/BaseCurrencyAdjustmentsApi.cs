...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/basecurrencyadjustment";
        ...
        /// </summary>
        /// <param name="new_base_currency_adjustment_info">
        ///     The new_base_currency_adjustment_info is the BaseCurrencyAdjustment
        ///     object which contains the currency_id,adjustment_date,exchange_rate and notes as mandatory parameters.
        /// </param>
        /// <param name="parameters">
        ///     The parameters contains the following key value pair<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>account_ids*</td><td>ID of the accounts for which base currency adjustments need to be posted.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        /// <returns>BaseCurrencyAdjustment.</returns>
        public BaseCurrencyAdjustment Create(BaseCurrencyAdjustment new_base_currency_adjustment_info,
        ...
        /// <param name="base_currency_adjustment_id">
        ///     The base_currency_adjustment_id is the identifier of the base currency
        ///     adjustment which is going to be deleted.
        /// </param>
