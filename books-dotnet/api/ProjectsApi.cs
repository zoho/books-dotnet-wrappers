...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/projects";
        ...
        {
            var url = baseAddress + "/" + project_id + "/active";
...
//------------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + project_id + "/users/invite";
...
//------------------------------------------------------------------------------------------------------
        ...
        /// </summary>
        /// <param name="time_entry_info">
        ///     The time_entry_info is the TimeEntry object with project_id,task_id,user_id and log_date
        ...
        {
            var url = baseAddress + "/" + project_id + "/comments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
