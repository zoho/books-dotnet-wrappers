...
namespace zohobooks.api
{
    ...
    ///     ,<br></br>
    ///     Update the details,templates,billing and shipping addresses,attachment preferences,comment of the specifed invoice,
    ///     <br></br>
    ...
    {
        private static readonly string baseAddress = baseurl + "/invoices";
        ...
        ///             <td>
        ///                 Search invoices by invoice number.<br></br>Variants: <i>invoice_number_startswith</i> and
        ///                 <i>invoice_number_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_name</td>
        ///             <td>
        ///                 Search invoices by item name.<br></br>Variants: <i>item_name_startswith</i> and
        ///                 <i>item_name_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_id</td><td>Search invoices by item id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>item_description</td>
        ///             <td>
        ///                 Search invoices by item description.<br></br>Variants: <i>item_description_startswith</i> and
        ...
        ///             <td>
        ///                 Search invoices by invoice reference number (i.e., P.O.#).<br></br>Variants:
        ///                 <i>reference_number_startswith</i> and <i>reference_number_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>customer_name</td>
        ///             <td>
        ///                 Search invoices by customer name.<br></br>Variants: <i>customer_name_startswith</i> and
        ///                 <i>customer_name_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>recurring_invoice_id</td><td>Search invoices by recurring profile id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>email</td><td>Search invoices by customer contact persons email.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>total</td>
        ///             <td>
        ///                 Search invoices by invoice total.<br></br>Variants:
        ...
        ///             <td>
        ///                 Search invoices by invoice total.<br></br>Variants:
        ///                 <i>balance_less_than, balance_less_equals, balance_greater_than</i> and <i>balance_greater_equals</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>date</td>
        ///             <td>
        ///                 Search invoices by invoice date.<br></br>Variants: <i>date_start, date_end, date_before</i> and
        ///                 <i>date_after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>due_date</td>
        ///             <td>
        ///                 Search invoices by due date.<br></br>Variants: <i>due_date_start, due_date_end, due_date_before</i> and
        ///                 <i>due_date_after</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>status</td>
        ///             <td>
        ///                 Search invoices by invoice status.<br></br>Allowed Values:
        ///                 <i>sent, draft, overdue, paid, void, unpaid, partiallypaid</i> and <i>viewed</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>customer_id</td><td>Search invoices by customer id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>custom_field</td>
        ///             <td>
        ///                 Search invoices by custom fields.<br></br>Variants: <i>custom_field_startswith</i> and
        ///                 <i>custom_field_contains</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ///                 Filter invoices by any status or payment expected date.<br></br>Allowed Values:
        ///                 <i>
        ///                     Status.All, Status.Sent, Status.Draft, Status.OverDue, Status.Paid, Status.Void, Status.Unpaid,
        ///                     Status.PartiallyPaid, Status.Viewed
        ///                 </i>
        ///                 and <i>Date.PaymentExpectedDate</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>search_text</td><td>Search invoices by invoice number or purchase order or customer name.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_column</td>
        ///             <td>
        ///                 Sort invoices.<br></br>Allowed Values:
        ///                 <i>customer_name, invoice_number, date, due_date, total, balance</i> and <i>created_time</i>
        ///             </td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        ///     <table>
        ///         <tr>
        ///             <td>print</td><td>Print the exported pdf.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>accept</td>
        ///             <td>
        ///                 Get the details of a particular invoice in formats such as json/ pdf/ html. Default format is json.
        ///                 <br></br>Allowed Values: <i>json, pdf</i> and <i>html</i>
        ///             </td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        ///             <td>send</td>
        ///             <td>
        ///                 Send the invoice to the contact person(s) associated with the invoice.<br></br>Allowed Values:
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/status/sent";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }

        /// <summary>
        ///     Mark an invoice status as void. Upon voiding, the payments and credits associated with the invoices will be
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/status/void";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/status/draft";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }

        /// <summary>
        ///     Email an invoice to the customer. Input json string is not mandatory. If input json string is empty, mail will be
        ///     send with default mail content.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        ...
        ///     <table>
        ///         <tr>
        ///             <td>send_customer_statement</td><td>Send customer statement pdf a with email.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>send_attachment</td><td>Send the invoice attachment a with the email.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        /// <returns>System.String<br></br> The success message is "Your invoice has been sent."</returns>
        public string SendEmail(string invoice_id, EmailNotification email_details, string[] attachment_paths,
            Dictionary<object, object> parameters)
        {
            var url = baseAddress + "/" + invoice_id + "/email";
        ...
        /// <param name="parameters">
        ///     The parameters is the dictionary object which is having the following mandatory parameter in the form of key,value
        ///     pair.<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>invoice_ids</td><td>Comma separated invoice ids which are to be emailed.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which contains the optional parameter that will provides the template as
        ...
        ///                 content will be based on the email template associated with the customer. If no template is associated
        ...
        /// <summary>
        ///     Remind your customer about an unpaid invoice by email. Reminder will be sent, only for the invoices which are in
        ///     open or overdue status.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="notify_details">
        ///     The notify_details is the EmailNotification object with to_mail_ids as mandatory
        ///     parameter.
        /// </param>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which contains the following optional parameter in the key,value pair
        ///     format.<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>send_customer_statement</td><td>Send customer statement pdf a with payment reminder.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        /// <returns>System.String<br></br> The success message is "Your payment reminder has been sent."</returns>
        public string RemindCustomer(string invoice_id, EmailNotification notify_details,
            Dictionary<object, object> parameters)
        {
            var url = baseAddress + "/" + invoice_id + "/paymentreminder";
        ...
        /// <summary>
        ///     Remind your customer about an unpaid invoices by email. Reminder mail will be send, only for the invoices is in
        ///     open or overdue status. Maximum 10 invoices can be reminded at once.
        /// </summary>
        /// <param name="parameters">
        ///     The parameters is the dictionary object which conatins the following mandatory pameter in the key value pair
        ///     format.<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>invoice_ids*</td><td>Array of invoice ids for which the reminder has to be sent.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        {
            var url = baseAddress + "/paymentreminder";
            var responce = ZohoHttpClient.post(url, getQueryParameters(parameters));
            return InvoiceParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/paymentreminder/disable";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/paymentreminder/enable";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/writeoff";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/writeoff/cancel";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }

        /// <summary>
        ///     Updates the billing address for this invoice alone. You can set this address as default billing address for your
        ///     customer by specifying 'is_update_customer' param as true.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/address/billing";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
        ...
        /// <summary>
        ///     Updates the shipping address for this invoice. You can set this address as default shipping address for your
        ///     customer by specifying 'is_update_customer' param as true.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="update_info">The update_info ois the Address object which contains the updation information.</param>
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/address/shipping";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.put(url, getQueryParameters(jsonstring));
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/templates/" + template_id;
...
//-------------------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/payments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/creditsapplied";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
            return InvoiceParser.getCredits(responce);
        }

        /// <summary>
        ///     Apply the customer credits either from credit notes or excess customer payments to an invoice. Multiple credits can
        ///     be applied at once.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="credits_to_apply">
        ///     The credits_to_apply is the UseCredits object which contains the credits information to
        ///     apply.
        /// </param>
        /// <returns>UseCredits object.</returns>
        public UseCredits AddCredits(string invoice_id, UseCredits credits_to_apply)
        {
            var url = baseAddress + "/" + invoice_id + "/credits";
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/payments/" + payment_id;
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
...
//----------------------------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/comments";
            ;
            var responce = ZohoHttpClient.get(url, getQueryParameters());
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="new_comment_info">
        ///     The new_comment_info is the Comment object which contains the information to add a new
        ///     comment.
        /// </param>
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/comments/" + comment_id;
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.put(url, getQueryParameters(jsonstring));
...
//--------------------------------------------------------------------------------------------
        ...
        {
            var url = baseAddress + "/" + invoice_id + "/attachment";
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="attachment_Path">
        ///     The attachment_ path is the file information which is going to be attached to thr
        ///     invoice.
        /// </param>
        /// <param name="parameters">
        ///     The parameters is the Dictionary object which contains the following optional parameter in the form of key,value
        ///     pair.<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>can_send_in_mail</td><td>True to send the attachment with the invoice when emailed.</td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="parameters">
        ///     The parameters is the Dictionary object which contains the following mandatory parameter in the form of key,value
        ///     pair.<br></br>
        ///     <table>
        ///         <tr>
        ///             <td>can_send_in_mail*</td><td>True to send the attachment with the invoice when emailed.</td>
        ...
        {
            var url = baseAddress + "/expenses/" + expense_id + "/receipt";
            var responce = ZohoHttpClient.delete(url, getQueryParameters());
            return InvoiceParser.getMessage(responce);
        }
    }
