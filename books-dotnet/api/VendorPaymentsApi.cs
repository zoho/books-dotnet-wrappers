...
namespace zohobooks.api
{
    ...
    {
        private static readonly string baseAddress = baseurl + "/vendorpayments";
        ...
        ///             <td>vendor_name</td>
        ///             <td>
        ///                 Search payments by vendor name.<br></br>Variants: <i>vendor_name_startswith</i> and
        ...
        ///         </tr>
        ///         <tr>
        ///             <td>vendor_id</td><td>Search payments by vendor id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>bill_id</td><td>Search payments by bill id.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>filter_by</td>
        ///             <td>
        ...
        ///                     PaymentMode.BankRemittance, PaymentMode.Payflowpro
        ///                 </i>
        ///                 and <i>PaymentMode.Others</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>search_text</td><td>Search payments by reference number or vendor name or payment description.</td>
        ///         </tr>
        ///         <tr>
        ///             <td>sort_column</td>
        ///             <td>
        ///                 Sort the payment list.<br></br>Allowed Values: <i>vendor_name, date, reference_number, amount</i> and
        ///                 <i>balance</i>
        ///             </td>
        ///         </tr>
        ///         <tr>
        ///             <td>notes</td>
        ///             <td>Search payments by notes.<br></br>Variants: <i>notes_startswith</i> and <i>notes_contains</i></td>
        ///         </tr>
        ///     </table>
        /// </param>
        ...
        {
            var url = baseAddress + "/" + payment_id;
        ...
        /// </summary>
        /// <param name="new_vendorpayment_info">
        ///     The new_vendorpayment_info is the VendorPayment object with vendor_id and amount
