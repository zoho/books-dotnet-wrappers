...
namespace zohobooks.api
{
    ...
    ///     Get and update the details of the specified currency,tax,exchange rate,taxgroup,opening balence and an auto and
    ///     manual reminder,<br></br>
    ...
    public class SettingsApi : Api
    {
        ...
        ///     The base address
        /// </summary>
        private static readonly string baseAddress = baseurl + "/settings";
        ...
        {
            var url = baseAddress + "/invoices/notesandterms";
            var response = ZohoHttpClient.get(url, getQueryParameters());
        ...
        /// </summary>
        /// <param name="update_info">
        ///     The update_info is the NotesAndTerms object which contains the invoice notes and terms
        ...
        {
            var url = baseAddress + "/estimates/notesandterms";
            var response = ZohoHttpClient.get(url, getQueryParameters());
            return SettingsParser.getNotesAndTerms(response);
        }
        ...
        /// </summary>
        /// <param name="new_currency_info">
        ///     The new_currency_info is the currency info with the currency_code,currency_symbol and
        ///     currency_format as the mandatory attributes.
        /// </param>
        /// <returns>Currency object.</returns>
        ...
        /// </summary>
        /// <param name="currency_id">The currency_id is the identifier of the currency.</param>
        /// <param name="new_exchange_rate_info">
        ///     The new_exchange_rate_info is the ExchangeRate object with effective_date and rate
        ...
        /// <summary>
        ///     Create a tax group associating multiple taxes.A tax group should contain minimum of 2 taxes.Only one compund tax
        ///     can be associated to a tax group along with other taxes.
        /// </summary>
        /// <param name="new_tax_group_info">
        ///     The new_tax_group_info is the TaxGroup object with tax_group_name,taxes are mandatory
        ///     attributes.
        /// </param>
        /// <returns>TaxGroup object.</returns>
        public TaxGroup CreateTaxGroup(TaxGroupToCreate new_tax_group_info)
        {
            var url = baseAddress + "/taxgroups";
        ...
        /// </summary>
        /// <param name="new_opening_balance_info">
        ///     The new_opening_balance_info is the OpeningBalance object with date and
        ///     debit_or_credit are mandatory attributes.
        /// </param>
        /// <returns>OpeningBalance object.</returns>
        ...
        {
            var url = baseAddress + "/autoreminders/" + reminder_id + "/enable";
